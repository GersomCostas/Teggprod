#' 70. VARIANCE for mackerel.  When there's extrapolation the variance is adjusted appropiately ( including contributed area of rectangles used for extrapolation)
...

{
  ...
  out <- ldply(data1,plyr::failwith(NA, function(x)
